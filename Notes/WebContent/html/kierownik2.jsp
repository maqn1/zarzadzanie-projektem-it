			...
			<div class="container">
				...
				<div>
					<div style="width:460px; margin:0 auto;">
						...
						<ul>
							<li><a href="DodajKierowca.jsp">ADD DRIVER</a>
							</li>
						</ul><br><br><br>
					</div>
				</div>
				<table align="center" class="tg">
					<tr>
	    				<th class="tg-cqdd" colspan="10"><b>MANAGER PANEL - DRIVER</b></th>
	 				</tr>
					<tr>
						...
						<th class="tg-jb24">Remove driver</th>
				 	</tr>
					<%
						try{
							connection = DriverManager.getConnection(url, user, pass);
							statement = connection.createStatement();
							String sql = "SELECT * FROM KIEROWCA ORDER BY ID_KIEROWCY;";
						
							resultSet = statement.executeQuery(sql);
							while(resultSet.next()){
					%>
					<tr>
						<td class="tg-i81m"><%=resultSet.getString("ID_KIEROWCY") %></td>
						...
						<td class="tg-r31x">
							<form action="DaneKierowcyEdycja.jsp">
								<input type="hidden" name="idKierowcy" value="<%=resultSet.getString("ID_KIEROWCY") %>"/>
								<input type="submit" value="Edit" class="btn-edit"/>
							</form>
						</td>
						<td class="tg-r31x">
							<form action="UsunKierowca.jsp">
								<input type="hidden" name="idKierowcy" value="<%=resultSet.getString("ID_KIEROWCY") %>"/>
