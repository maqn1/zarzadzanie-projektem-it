...
<html>
	...
	<body>
		<%
			int id = Integer.parseInt(request.getParameter("idKlienta"));
    	...
    	%>
    	<div class="container">
	    	<form align="center" action="DaneKlientaEdycja2.jsp" enctype="multipart/form-data">
				...
				<input type="text" name="liczba_kalorii" placeholder="enter calories number " required></input>
				<input type="hidden" name="idKlienta" value="<%=id%>"/><br>
