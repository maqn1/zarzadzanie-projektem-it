...
<html>
	...
	<body>
		<%
			...
			Integer liczba_kalorii = Integer.parseInt((String)request.getParameter("liczba_kalorii"));
		    ...
		    String pass = "maciek";
				...
				String sql = "INSERT INTO KLIENT(ID_KLIENTA, IMIE, NAZWISKO, TELEFON, ULICA, MIASTO, LICZBA_KALORII) VALUES('"+id+"', '"+imie+"' , '"+nazwisko+"' , '"+telefon+"' , '"+ulica+"' , '"+miasto+"' , '"+liczba_kalorii+"')";
