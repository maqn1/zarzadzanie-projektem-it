...
<html>
	...
	<body>
	    ...
	    %>
		<div class="container">
			<form align="center" action="DodajKierowca2.jsp" enctype="multipart/form-data">
				<div>
				...
				<input type="text" name="nazwisko" placeholder="enter surnameo" required></input>
				<input type="number" name="telefon" placeholder="enter phone number" required></input><br>
