			...
			<div class="container">
				...
				<div>
					<div style="width:460px; margin:0 auto;">
						...
						<ul>
							<li><a href="DodajZamowienie.jsp">ADD ORDER</a>
							</li>
						</ul><br><br><br>
					</div>
				</div>
				<table align="center" class="tg">
					<tr>
	    				<th class="tg-cqdd" colspan="10"><b>MANAGER PANEL - ORDER</b></th>
	 				</tr>
					<tr>
						<th class="tg-jb24">ID</th>
						<th class="tg-jb24">Price</th>
						<th class="tg-jb24">Delivery time</th>
						<th class="tg-jb24">Customer ID</th>
						<th class="tg-jb24">Driver ID</th>
					...
					<%
						try{
							...
							String sql = "SELECT * FROM ZAMOWIENIE ORDER BY ID_ZAMOWIENIA;";
					...
					<tr>
						...
						<td class="tg-baqh"><%=resultSet.getString("ID_KLIENTA") %></td>
						<td class="tg-baqh"><%=resultSet.getString("ID_KIEROWCY") %></td>
						<td class="tg-r31x">
							<form action="DaneZamowienieEdycja.jsp">
								<input type="hidden" name="idZamowienia" value="<%=resultSet.getString("ID_ZAMOWIENIA") %>"/>
								<input type="submit" value="Edit" class="btn-edit"/>
							</form>
						</td>
						<td class="tg-r31x">
							<form action="UsunZamowienie.jsp">
								<input type="hidden" name="idZamowienia" value="<%=resultSet.getString("ID_ZAMOWIENIA") %>"/>
