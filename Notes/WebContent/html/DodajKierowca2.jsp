	...
	<body>
		<%
		    ...
		    String pass = "maciek";
				...
				String sql = "INSERT INTO KIEROWCA(ID_KIEROWCY, IMIE, NAZWISKO, TELEFON) VALUES('"+id+"', '"+imie+"' , '"+nazwisko+"' , '"+telefon+"')";
				statement.executeUpdate(sql);
		%>
		<div class="container">
			<a href="kierownik2.jsp"><img src="http://muktafabrics.com/web/wp-content/uploads/2016/03/blue-heading-icons_thumbsup.png" /></a>
			<form enctype="multipart/form-data">
				<div class="alert-box success">
					<span>success: </span>Driver added correctly!
				</div>
			</form>
		</div>
		<footer>
