...
<html>
	...
	<body>
    	...
    	%>
    	<div class="container">
	    	<form align="center" action="DanePlatnoscEdycja2.jsp" enctype="multipart/form-data">
				<input type="text" name="id_zamowienia" placeholder="enter order id" required></input>
				<input type="text" name="zaplacono" placeholder="how many paid?" required></input>
				<input type="hidden" name="idPlatnosci" value="<%=id%>"/><br>
