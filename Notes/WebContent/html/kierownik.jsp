			...
			<div class="container">
				...
				<div>
					<div style="width:460px; margin:0 auto;">
						<ul>
							<li><a href="#">VIEW</a>
								<ul>
									...
									<li><a href="kierownik4.jsp">PAYMENTS</a></li>
								</ul>
							</li>
						</ul>
						<ul>
						...
						<ul>
							<li><a href="DodajKlient.jsp">ADD CUSTOMER</a>
							</li>
						</ul><br><br><br>
					</div>
				</div>
				<table align="center" class="tg">
					<tr>
	    				<th class="tg-cqdd" colspan="10"><b>MANAGER PANEL - CUSTOMER</b></th>
	 				</tr>
					<tr>
						<th class="tg-jb24">ID</th>
						<th class="tg-jb24">Name</th>
						<th class="tg-jb24">Surname</th>
						<th class="tg-jb24">Phone number</th>
						<th class="tg-jb24">Street</th>
						<th class="tg-jb24">City</th>
						<th class="tg-jb24">Calories number</th>
						<th class="tg-jb24">Edit data</th>
						<th class="tg-jb24">Remove customer</th>
				 	</tr>
					<%
						try{
							connection = DriverManager.getConnection(url, user, pass);
							statement = connection.createStatement();
							String sql = "SELECT * FROM KLIENT ORDER BY ID_KLIENTA;";
						
							resultSet = statement.executeQuery(sql);
							while(resultSet.next()){
					%>
					<tr>
						<td class="tg-i81m"><%=resultSet.getString("ID_KLIENTA") %></td>
						<td class="tg-baqh"><%=resultSet.getString("IMIE") %></td>
						<td class="tg-baqh"><%=resultSet.getString("NAZWISKO") %></td>
						<td class="tg-baqh"><%=resultSet.getString("TELEFON") %></td>
						<td class="tg-baqh"><%=resultSet.getString("ULICA") %></td>
						<td class="tg-baqh"><%=resultSet.getString("MIASTO") %></td>
						<td class="tg-baqh"><%=resultSet.getString("LICZBA_KALORII") %></td>
						<td class="tg-r31x">
							<form action="DaneKlientaEdycja.jsp">
								<input type="hidden" name="idKlienta" value="<%=resultSet.getString("ID_KLIENTA") %>"/>
								<input type="submit" value="Edit" class="btn-edit"/>
							</form>
						</td>
						<td class="tg-r31x">
							<form action="UsunKlient.jsp">
								<input type="hidden" name="idKlienta" value="<%=resultSet.getString("ID_KLIENTA") %>"/>
